...
namespace TheatreWebApplication.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public ProducersController(TheatreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Acts", new { id = producer.Id, name = producer.ProducerName, flag = 0 });
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProducerName")] Producer producer)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheatreContext.Producers'  is null.");
            }
            var producer = await _context.Producers.FindAsync(id);
            if (producer != null)
            {
